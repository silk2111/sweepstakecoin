...
#ifdef Q_OS_MAC
    resize(960, 610);
    setWindowTitle(tr("SweepstakeCoin wallet - Mac"));
#elif _WIN32
    resize(890, 600);
    setWindowTitle(tr("SweepstakeCoin wallet - Windows"));
#else
    resize(1020, 650);
    setWindowTitle(tr("SweepstakeCoin wallet - Linux"));
#endif
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SweepstakeCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About SweepstakeCoin"), this);
    aboutAction->setToolTip(tr("Show information about SweepstakeCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for SweepstakeCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SweepstakeCoin client") + QString(" ") + tr("[testnet]")); 
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SweepstakeCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SweepstakeCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SweepstakeCoin address or malformed URI parameters."));
    }
